...
public class ItemsPagerAdapter extends PagerAdapter implements IconPagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		mainLayout.findViewById(R.id.photo_pager_container).setVisibility(View.VISIBLE);
		ViewPager viewPager = (ViewPager) mainLayout.findViewById(R.id.list_item_photo_viewpager);
		viewPager.setVisibility(View.VISIBLE);
		ItemsPhotoPagerAdapter adapter = new ItemsPhotoPagerAdapter(mContext, mAdapterData.get(position).getPhotos(mContext));
		viewPager.setAdapter(adapter);
		final IconPageIndicator indicator = (IconPageIndicator) mainLayout.findViewById(R.id.indicator);
